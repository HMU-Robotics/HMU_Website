    ...
    return(
        <div className="about-cont">
            <div className="about-first-right">
                <img id="about-img-1" src="/Media/about.jpg"/>
                <p className="about-text">Η Λέσχης Ρομποτικής του ΕΛΜΕΠΑ είναι μία ομάδα φοιτητών που έχει ως σκοπό να δώσει στους φοιτητές την ευκαιρία να γνωρίσουν τους κλάδους που σχετίζονται με τη Ρομποτική. Μέσω σεμιναρίων, projects και διαγωνισμών, τα μέλη μας διευρύνουν τις γνώσεις τους αλληλεπιδρώντας με συμφοιτητές τους, με τους οποίους μοιράζονται το ίδιο πάθος. Ανακαλύπτοντας τους κλάδους που απαρτίζουν τη Ρομποτική, μαθαίνουν να δημιουργούν ομαδικά σε ένα φιλικό περιβάλλον. Ευπρόσδεκτοι είναι φοιτητές από κάθε σχολή και έτος φοίτησης.</p>
            </div>
            <div className="about-second-left">
                ...
                <img id="about-img-2" src="/Media/arduino.jpg"/>
            </div>
        </div>
    )
}
